...
public class IPMSGConst {
    ...
    public static final String IPMSG_CHARSET = "gbk";

    public static final int CONNECT_SUCCESS          = 0x00000074;	//连接成功
    public static final int IPMSG_SEND_TXT           = 0x00000075;	//发送文本;
}
